#' Meta-analysis for fixed-effect - C3
#' @description Meta-analysis for fixed-effect - C3
#' @usage
#' MetaFEC3(info,alpha=0.05)
#' @param info sample median
#' @param alpha significance level
#' @author Yanda Lang, Joseph McKean
#' @note format for info (median, sample size)
#' @examples
...
MetaFEC3 = function(info,alpha=0.05){
  ...
  # Calculate shift between two sample median, variance, and sample size
  for (i in 1:K) {
    j = 2*i-1
    # shift
