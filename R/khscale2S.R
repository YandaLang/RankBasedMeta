#' Kloke-Yabes procedure - two-sample
#' @description Kloke-Yabes procedure - two-sample
#' @usage
#' khscale2S(deltahat,mumat,ssmat)
#' @param deltahat shift estimates matrix
#' @param mumat one-sample location estimates matrix
...
khscale2S <- function(deltahat,mumat,ssmat){
  #
  ...
  mu1hat = mumat[,1]; mu2hat = mumat[,2]

  t1star = xi1*(mu2hat+deltahat+mu1hat)/2
  t2star = xi2*(mu2hat-deltahat+mu1hat)/2
