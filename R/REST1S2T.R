#' Meta-analysis for random-effect with non-pooled variance - standard
#' @description Meta-analysis for random-effect with non-pooled variance - standard
#' @usage
#' REST1S2T(info,alpha=0.05)
...
REST1S2T = function(info,alpha=0.05){
  K = nrow(info)
