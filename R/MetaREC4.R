#' Meta-analysis for random-effect - C4
#' @description Meta-analysis for random-effect - C4
#' @usage
#' MetaREC4(info,alpha=0.05)
#' @param info median, standard deviation, and sampel size
#' @param alpha significance level
#' @author Yanda Lang, Joseph McKean
#' @note format for info (median,sd,sample size)
#' @examples
...
MetaREC4 = function(info,alpha=0.05){
